 ...
 */
func triangleArea(x: Double, y: Double) -> Double? {
    guard x > 0 && y > 0 else {
        return nil
    }
    return ( x * y) / 2
...
if let result = triangleArea(x: 3, y: -6) {
    print(result)
} else {
    print("failed")
}
...
if let test1 = addOptionals(num1: 6, num2: 5) {
    print(test1)
}
if let test2 = addOptionals(num1: 6, num2: nil) {
    print(test2)
}
/*:
...
if let create = createUser() {
    print(create.firstName, create.lastName)
    print(create.age)
}
/*:
