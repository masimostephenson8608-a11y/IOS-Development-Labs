...
let hearRate1D:Double = 61
let heartRate2D:Double = 73
let heartRate3D:Double = 78
let addedHRD = hearRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)
//It slightly differs because when its a double, the quotient isn't rounded down to the nearest integer.
