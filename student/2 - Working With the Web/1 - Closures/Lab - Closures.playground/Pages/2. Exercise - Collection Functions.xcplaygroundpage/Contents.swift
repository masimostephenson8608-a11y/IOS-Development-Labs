...
forwards(name1: "jack", name2: "Meghan")
...
let collection: [String] = ["Masimo", "Mariana", "Damiana", "Tadeo", "Giovana", "Kyle"]
let sortedCollection1 = collection.sorted(by: forwards)
...
let sortedCollection2 = collection.sorted(by: { (name1: String, name2: String) -> Bool in
    return name1 < name2
})
...
let sortedCollection3 = collection.sorted(by: { $0 < $1 })
