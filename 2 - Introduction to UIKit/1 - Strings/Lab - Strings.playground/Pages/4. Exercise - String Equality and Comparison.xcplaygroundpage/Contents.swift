...
if (textToSearchThrough.contains(textToSearchFor) == true || textToSearchThrough.lowercased().contains(textToSearchFor) == true) {
    print("I found it!")
}
